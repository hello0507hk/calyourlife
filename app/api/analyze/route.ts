...
### 一、 日主旺衰、論調候、定格局、評論格局高低，捉用神，詳細指出原局八字中的「病」和「藥」
- 分析日主在月令的得令狀況與四柱整體氣勢。分析原局八字時，首要條件是先陰陽，後五行。先看命主是陽日元還是陰日元，陽日元喜尅不喜泄，要有根，陰日元喜泄不喜尅，不怕弱
- 判斷日主偏強、偏弱或特殊格局，看是否有調候，如果有殺，則需要有殺先論殺，日主和殺相比，殺弱就以財滋殺，日主比殺弱，就必要用傷官或食神制殺，或用印化殺，用十天干喜用配合月令分析，絕對要留意天干有合化者，要留意真化還是假化，可參考滴天髓徵義的化象篇和假化篇，因化神可當用神或調候用神，明確列出並解釋八字原局的「用神」、「病」和「藥神」。

### 二、 格局與十神性格分析
- 必須說明原命局的主要格局或者是無格局 (參考滴天髓中所提到的格局）。
