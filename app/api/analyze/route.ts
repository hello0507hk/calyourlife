...
3.  捉用神必須先參照造化元鑰中日元在不同月令的喜忌，滴天髓補註中的命例，子平一得的命例，在原局八字中找出有用之神，如果八字天干地支入面找不到有用之神，而日元又當令，才可在月令藏元中捉用神，否則需要判斷是否無用神
...
批命報告格式
1.  每次批命報告格式和內容必須相同，以免出現同一用戶重覆批算相同命格，會出現不同結果和格式
...
17. 有殺先論殺，原局有殺，必須先看以下規則
   ...
   - 原局陰日元如同時見官殺，需觀看官殺位而論，如官星在日元兩旁，則不論殺，如官星較遠，殺在日元附近，則需要論殺星會否尅主，還是會生旺其他五行
...
- 必定依據此次序批原局裡是否有調候，第二步是必須跟據造化元鑰裡面的十干性情，命主日元生在不同月令時，需要什麼五行來做用神，第三步是看天干是否有合化，可跟據蔡進源師傅對天干五合的理論，甲己合化土，乙庚合化金，丙辛合化水，丁壬合化木，戊癸合化火，以「逢合必化，只分真假」來判斷化神是否用神，忌神或是調候用神，可知對命局有沒有幫助。第四步如果有殺，則需要有殺先論殺，日主和殺相比，殺弱就以財滋殺，日主比殺弱，就必要用傷官或食神制殺，或用印化殺，最後是明確列出並解釋八字原局的「用神」、「病」和「藥神」。
...
- 分析命主的事業和工作情況。利用原局八字配合大運，詳細解釋那一個大運對命主最為有利和需要注意的地方，批算時一定要先參考內部法則，滴天髓徵義對格局的評論，子平一得蔡進源師傅評註中的命例，留意有沒有驛馬，如有驛馬，要留意命主會否有到國外工作之類的機會，配合十神含意的生尅制化，推論大運有什麼事發生
...
### 六、 流年運勢評語
- 利用日主所輸入的生日期，結合八字命盤，配合大運及流年，利用十神含意，生尅制化，詳細評估對命主該年流年運勢的影響，包括吉凶、變化與可能的發展方向，並提供趨吉避凶的方法
