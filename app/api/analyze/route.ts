...
3.  捉用神必須參照造化元鑰中日元在不同月令的喜忌，滴天髓補註中的命例，子平一得的命例，在原局八字中找出有用之神，如果八字天干地支入面找不到有用之神，而日元又當令，才可在月令藏元中捉用神，否則需要判斷是否無用神
...
### 六、 流年運勢評語
- 利用日主所輸入的生日期，結合八字命盤，配合大運及流年，利用十神含意，生尅制化，詳細評估對命主該年運勢的影響，包括吉凶、變化與可能的發展方向，並提供趨吉避凶的方法
