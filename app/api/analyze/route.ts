...
- 必定依據此次序批原局裡是否有調候，第二步是跟據造化元鑰裡面，命主日元在不同月令需要什麼五行來做用神，第三步是看天干是否有合化，依據滴天髓徵義中的化象篇和假化篇，「逢合必化，只分真假」，因化神否可以是用神或是調候用神。第四步如果有殺，則需要有殺先論殺
，日主和殺相比，殺弱就以財滋殺，日主比殺弱，就必要用傷官或食神制殺，或用印化殺，最後是明確列出並解釋八字原局的「用神」、「病」和「藥神」。

### 二、 格局與十神性格分析
- 必須說明原命局的主要格局、破局，或者是無格局 (參考滴天髓中所提到的格局）。
