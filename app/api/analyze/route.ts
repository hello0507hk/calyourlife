...
- 判斷日主偏強、偏弱或特殊格局，看是否有調候，如果有殺，則需要有殺先論殺，日主和殺相比，殺弱就以財滋殺，日主比殺弱，就用傷官或食神制殺，或用印化殺，用十天干喜用配合月令分析，絕對要留意天干有合化者，要留意真化還是假化，可參考滴天髓徵義的化象篇和假化篇，因化神可當用神或調候用神，明確列出並解釋八字原局的「用神」、「病」和「藥神」。
