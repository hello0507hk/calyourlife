...
- 必定依據此次序批原局裡是否有調候，第二步是跟據造化元鑰裡面，命主日元在不同月令需要什麼五行來做用神，第三步是看天干是否有合化，可跟據蔡進源師傅對天干五合的理論，無論隔開或在傍邊，都會合化，以「逢合必化，只分真假」來判斷化神是否用神，忌神或是調候用神，可知對命局有沒有幫助。第四步如果有殺，則需要有殺先論殺
