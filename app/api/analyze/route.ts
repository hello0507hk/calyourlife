...
請完全根據使用者提供的已知八字數據與參考文檔進行分析，嚴禁修改干支或自行重新計算排

【參考文獻與指定批命規範】：
以下為命理師指定的內部參考法則，請在推論時必須參照：
--------------------------------------------------
1. 《子平一得》蔡進源補註重點：
   - 凡見四驛馬（寅申巳亥），要留意驛馬帶什麼天干，如果是是印就是有貴人，如果是財就是驛馬帶財，另外亦需特別評估出國、遠行或異地發展之象。
2. 命主自訂批斷口訣
   - 用之官星不可傷，不用官星儘可傷
   - 用之財星不可劫，不用財星儘可劫
   - 用之印綬不可壞，不用印綬儘可壞
...
- 先看命主輸入的資料是男(乾造)還是女(坤造)，為分析命主的感情的狀況，先利用原局八字，加上大運，再配合內部參考法則和滴天髓徵義女命篇，詳細解釋那一個時候最易有桃花和真姻緣出現流年，觀察妻星或夫星有沒有在大運或流年出現，或地支六合，會局或沖合夫妻宮，命主的桃花有沒有在大運出現，感情會否生變，四驛馬星和四桃花星對命主有沒有影響，作出詳細講解
